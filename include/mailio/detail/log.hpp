...
Lightweight, header-only logging infrastructure for mailio.
...
#define MAILIO_LOG(lvl, msg) \
    ::mailio::log::logger::instance().log(lvl, msg, std::source_location::current())

#define MAILIO_TRACE(msg)  MAILIO_LOG(::mailio::log::level::trace, msg)
#define MAILIO_DEBUG(msg)  MAILIO_LOG(::mailio::log::level::debug, msg)
#define MAILIO_INFO(msg)   MAILIO_LOG(::mailio::log::level::info, msg)
#define MAILIO_WARN(msg)   MAILIO_LOG(::mailio::log::level::warn, msg)
#define MAILIO_ERROR(msg)  MAILIO_LOG(::mailio::log::level::error, msg)
#define MAILIO_FATAL(msg)  MAILIO_LOG(::mailio::log::level::fatal, msg)

/// Protocol trace helper
#define MAILIO_TRACE_SEND(protocol, data) \
    ::mailio::log::logger::instance().trace_protocol(protocol, ::mailio::log::direction::send, data)

#define MAILIO_TRACE_RECV(protocol, data) \
    ::mailio::log::logger::instance().trace_protocol(protocol, ::mailio::log::direction::receive, data)
