...
Utility functions to convert Asio error codes to mailio::error.
...
#include <mailio/detail/result.hpp>

namespace mailio
{

/// Convert asio::error_code to mailio::error
...
/// Helper to convert asio tuple result to mailio::result
template<typename T>
