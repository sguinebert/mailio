...
Centralized Boost.Asio / standalone Asio declarations for mailio.
...
#if defined(MAILIO_USE_STANDALONE_ASIO)
...
#else
#error "mailio requires coroutine support (C++20) and Asio 1.21+"
#endif
...
#else
#error "mailio requires coroutine support (C++20) and Boost.Asio 1.21+ (Boost 1.78+)"
#endif

#endif // MAILIO_USE_STANDALONE_ASIO
