...
#define MAILIO_HAS_SSL_HOST_NAME_VERIFICATION 1
#elif __has_include(<boost/asio/ssl/host_name_verification.hpp>)
#include <boost/asio/ssl/host_name_verification.hpp>
#define MAILIO_HAS_SSL_HOST_NAME_VERIFICATION 1
#endif
#elif defined(MAILIO_USE_STANDALONE_ASIO)
#include <asio/ssl/host_name_verification.hpp>
#define MAILIO_HAS_SSL_HOST_NAME_VERIFICATION 1
#else
#include <boost/asio/ssl/host_name_verification.hpp>
...
#include <mailio/net/tls_error.hpp>
#include <mailio/net/tls_options.hpp>
#include <mailio/net/tls_trust_store.hpp>
...
#if defined(MAILIO_HAS_SSL_HOST_NAME_VERIFICATION)
                if (opt.verify_host)
                {
